...
public interface AdminNewsApiMapper {
     ...
     */
    @Transactional
    Integer addNews(NewNewsDTO newNewsDTO) throws Exception;
     ...
     */
    @Transactional
    Integer updateNews(NewNewsDTO newNewsDTO) throws Exception;
     ...
     * @throws Exception
     */
    Map<String, Object> getNewsInfo(NewNewsDTO newNewsDTO) throws Exception;
}
